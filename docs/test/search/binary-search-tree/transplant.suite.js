suite('search/binary-search-tree#transplant', function(suite) {
  ...
  bench('ts-runtime', function() {
    ...
    var node = tree.root.right.right;
    var replacement = tsr.createNode(21);
    
    tsr.transplant(tree, node, replacement);
  });
  ...
  bench('original', function() {
    ...
    var node = tree.root.right.right;
    var replacement = pkg.createNode(21);
    
    pkg.transplant(tree, node, replacement);
  });
